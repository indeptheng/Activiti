 ...
 */
public class DocumentTaskJsonConverter extends BaseBpmnJsonConverter {
  ...
  public static void fillJsonTypes(Map<String, Class<? extends BaseBpmnJsonConverter>> convertersToBpmnMap) {
    convertersToBpmnMap.put(STENCIL_TASK_DOCUMENT, DocumentTaskJsonConverter.class);
  }
  ...
  protected FlowElement convertJsonToElement(JsonNode elementNode, JsonNode modelNode, Map<String, JsonNode> shapeMap) {
    ...
    addField("outputfiletitle", PROPERTY_DOCUMENTTASK_OUTPUTFILETITLE_VARIABLE, elementNode, task);
